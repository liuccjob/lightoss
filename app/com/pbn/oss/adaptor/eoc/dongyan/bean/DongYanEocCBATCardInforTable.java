...
public class DongYanEocCBATCardInforTable{ 
	...
	public DongYanEocCBATCardInforTable() {
		super();
	}

	public DongYanEocCBATCardInforTable(String modelType, String fwVersion,
			String hwVersion, String mac, Integer onlineStatus,
			String serialNumber, String vendor, Long upTime,
			Long uFrameInterval1, Long uFrameInterval2, String uplinkMac,
			Integer uplinkPort, Integer currentTemperature, Integer index,
			Integer rfLinkMax, Integer rfOutputLevel, Long rfDsStartFrq,
			Long rfDsStopFrq, Long rfUsStartFrq, Long rfUsStopFrq, String id) {
		super();
	...
	public void setuFrameInterval1(java.lang.Long uFrameInterval1) {
		this.uFrameInterval1 = uFrameInterval1;
	}
	...
	public void setuFrameInterval2(java.lang.Long uFrameInterval2) {
		this.uFrameInterval2 = uFrameInterval2;
	}
