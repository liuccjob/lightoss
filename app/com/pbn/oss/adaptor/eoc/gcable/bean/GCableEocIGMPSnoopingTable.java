...
public class GCableEocIGMPSnoopingTable {
	...
	public GCableEocIGMPSnoopingTable() {
		super();
	}

	public GCableEocIGMPSnoopingTable(Integer igmpCNUIndex,Integer igmpEN, String id) {
		super();
